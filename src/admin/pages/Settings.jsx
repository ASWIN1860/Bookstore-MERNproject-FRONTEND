            ...
            <div className="p-2">
              <div className="w-full h-full bg-blue-300 py-4 px-7 rounded">
                ...
                <input
                  ...
                  onChange={(e)=>{setProfileData({...profileData.username.target.value})}}
                ...
                <input
                  ...
                  className="w-full bg-white border rounded-sm my-5 py-2"
                  placeholder="Bio"
                  onChange={(e)=>{setProfileData({...profileData.bio.target.value})}}
                ...
                <input
                  ...
                  placeholder="Password"
                   onChange={(e)=>{setProfileData({...profileData.password.target.value})}}
                ...
                <input
                  ...
                  placeholder="Confirm password"
                   onChange={(e)=>{setProfileData({...profileData.confirmPassword.target.value})}}

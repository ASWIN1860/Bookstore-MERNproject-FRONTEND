...
import { ListJobPostApi ,applyJobPostApi} from "../../service/allApis";
    ...
    <>
      ...
      <div className="min-h-[60vh] px-5 py-10 md:px-40">
        ...
        <p className="text-justify my-5">
          Your career is more than just a job — it’s a journey of growth,
          learning, and self-discovery. Choosing the right career path allows
          you to explore your passions, develop valuable skills, and achieve
          both personal and professional goals. With the right opportunities and
          continuous effort, you can build a future that reflects your ambitions
          and strengths. Every experience, whether success or failure,
          contributes to shaping your career and guiding you toward long-term
            ...
            <div className="w-full">
              <div className="flex justify-center my-5">
                <input
                  ...
                  type="text"
                  className="border py-2 px-2 font-bold"
                  ...
                  {careerList.map((career) => (
                    <div className=" shadow-lg py-3 px-2 md:grid grid-cols-7 mb-4">
                      <div className="col-span-6">
                        ...
                        <hr />
                        <p className="mt-5 font-bold flex gap-2 items-center">
                      ...
                      <div className="px-10">
                        <button
                          className="bg-blue-800 text-white px-3 py-3 rounded-sm flex items-center"
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <div className="my-3">
                        <label
                          htmlFor=""
                          className="text-lg justify-end text-gray-600"
                        >
                          Resume
                        </label>
                        <input
                          ...
                          name=""
                          id=""
                          className="border w-full border-gray-500 cursor-pointer file:bg-gray-400 file:p-1 cursor-pointer"
                          ref={fileInputRef}
                    ...
                    <div className="bg-gray p-3 flex justify-end gap-2 rounded-b-2xl">
                      <button onClick={handleReset} className="p-2 border rounded-sm bg-red-500 text-white hover:bg-white hover:border-red-600 hover:text-red-500">
                        Reset
                      </button>
                      <button onClick={handleApplyJob} className="p-2 border rounded-sm bg-green-700 text-white hover:bg-white hover:border-green-600 hover:text-green-500">
                        Add
                      </button>
                    </div>
                  </div>
